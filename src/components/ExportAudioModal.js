...
const SAMPLE_RATE = 44100; //44khz sample rate
...
const Def = class ExportAudioModal extends React.Component {
	static propTypes = {
	...
	handleChangeValue = setStateFromEvent(this) //changes name and value of the componenet externally
...
const ExportAudioModal = withStyles(styles)(
	connect([
		'data',
		'tracks',
		'config',
