/*
* Code for volume sliders. Taken from credited libraries.
*/
...
function createSliderWithTooltip(Component) {
	return class HandleWrapper extends React.Component {
		...
		handleTooltipChange = (index, visible) => {
			...
			return (
				...
				>
					<Handle
						{...restProps}
						value={value}
						onMouseEnter={() => this.handleTooltipChange(index, true)}
						onMouseLeave={() => this.handleTooltipChange(index, false)}
					/>
				</Tooltip>
			);
		}
